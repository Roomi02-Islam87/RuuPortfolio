...
import L_ZOMATO from "../../assets/img/projects/zomato.jpeg";
import L_QUIZ from "../../assets/img/projects/quiz.jpeg";
                ...
                <Events>
                    ...
                    >
                        <div className="d-flex justify-content-between flex-column mt-1">
                                    ...
                                    <Card>
                                        ...
                                        <Accordion.Collapse eventKey="0" className="text-left">
                                            <Card.Body>
                                                ...
                                                <strong>Features:</strong>
                                                <ul className="list-styles pt-1">
                                                <li>Import pakages of ML.</li>
                                                <li>Applied Preprocessing and remove redundant data</li>
                            ...
                            <div className="d-flex justify-content-center flex-nowrap text-center">
                                <UrlButton
                                    href="https://www.kaggle.com/roomiislam098/zomato-rating-prediction"
                                    target="_blank"
                                >
                                    SEE LIVE
                                </UrlButton>
                    ...
                    >
                        <div className="d-flex justify-content-between flex-column mt-1">
                                ...
                                <Accordion>
                                    <Card>
                                        ...
                                        <Accordion.Collapse eventKey="0" className="text-left">
                                            <Card.Body>
                                                <strong>Description: </strong> 
                                                    This is a quiz website where u can play and earn marks .
                                                <hr />
                                                <strong>Features:</strong>
                                                <ul className="list-styles pt-1">
                                                    <li>Play Quiz</li>
                            ...
                            <div className="d-flex justify-content-center flex-nowrap text-center">
                                <UrlButton
                                    href="https://stoic-bhabha-626cd7.netlify.app/"
                                    target="_blank"
                                >
                                    SEE LIVE
                                </UrlButton>
